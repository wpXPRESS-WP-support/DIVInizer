...
### Lightbox :
Adds lightbox to images in posts and pages.
### Archive Blog Style : 
...
### Sidebar Removal : 
Grt ride of the sidebar globally, on archive or single posts pages.
### Recent Posts Widget : 
...
* Fixing preloader stuck on the new backend builder.
